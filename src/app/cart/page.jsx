            ...
            <div>
              ...
              <div className="cart-product">
                <div className="cart-product-block">
                  <div>
                    <p className="cart-product-title">Продукт</p>
                  </div>
                  <div>
                    <Image
                      ...
                      width="80"
                      height="80"
                      src="/images/img/product-card/armchairs/still/still1.jpg"
                      alt=""
                    />
                  </div>
                </div>
                <div className="b-bottom">
                  <div>
                    <div>
                      <p className="cart-product-title">назва продукту</p>
                    </div>
                    <div className="cart-product-title-info-block">
                      <h3 className="cart-product-name-title">French chair</h3>
                      <p className="cart-product-name-subtitle">A00001</p>
                    </div>
                  </div>

                  <div className="cart-product-counter">
                    <div>
                      <p className="cart-product-title">Кількість</p>
                    </div>
                    <div className="cart-product-counter-block">
                      <button className="cart-product-counter-btn">
                        <svg
                      ...
                      <p className="cart-product-counter-count">1</p>
                      <button className="cart-product-counter-btn">
                        <svg
                          className="cart-product-counter-svg"
                          width="24"
                  ...
                  <div>
                    <div>
                      <p className="cart-product-title">Ціна</p>
                    </div>
                    <div>
                      <div className="cart-product-price-block">
                        ...
                        <p className="cart-product-price-title">7 290</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="cart-product-bin">
                  <button className="cart-product-btn-bin">
                    <svg
              ...
              <p className="cart-undertable-text cart-undertable-text-mobile">
                ***У кожний товар можна внести індивідуальні зміни
              </p>
              <div className="cart-form-order">
                ...
                <div>
                  <div>
                    <p className="order-title">
                      <span className="order-title-num">1</span>Ваші дані
                    </p>
                  </div>
                  <div className="type-of-customer-block">
                    ...
                    >
                      <p className="type-of-customer-title">Я юридична особа</p>
                    ...
                    >
                      <p className="type-of-customer-title">Я фізична особа</p>
                    ...
                    {urIsOpen ? (
                      <form action="" className="cart-person-info">
                        <div className="cart-person-fieldsblock">
                          <label htmlFor="name" className="cart-person-label">
                          ...
                          />
                          <label htmlFor="tel" className="cart-person-label">
                            Телефон
                          </label>
                          <input
                            id="tel"
                        ...
                        <div className="cart-person-fieldsblock">
                          ...
                          <input
                            ...
                            className="cart-person-input"
                          />
                          <label htmlFor="town" className="cart-person-label">
                            Місто
                          </label>
                          <input
                            id="town"
                        ...
                        <div className="cart-person-fieldsblock">
                          <label htmlFor="code" className="cart-person-label">
                            Код ЄДРПОУ
                          </label>
                          <input
                            id="code"
                  ...
                  <div>
                    {fizIsOpen ? (
                      <form action="" className="cart-person-info-fiz">
                        ...
                        <div className="cart-person-fieldsblock">
                          <label htmlFor="email" className="cart-person-label">
                            Електронна пошта
                          </label>
                          <input
                            id="email"
                ...
                <div className="shipping-and-payment">
                  <div className="type-of-ordery">
                    <p className="order-title">
                      <span className="order-title-num">2</span>Доставка
                    </p>
                    <form action="#" className="type-of-ordery-form">
                      <input
                        ...
                        value="Нова пошта"
                      />
                      <label htmlFor="new-posht" className="order-info-label">
                        <span className="order-info-title">Нова пошта</span>
                      </label>
                      <input
                        className="order-info-input"
                        type="radio"
                        ...
                        value="Meest Express"
                      />
                      <label htmlFor="meest-posht" className="order-info-label">
                        <span className="order-info-title">Meest Express</span>
                      </label>
                      <input
                        className="order-info-input"
                        type="radio"
                      ...
                      >
                        <span className="order-info-title">Delivery</span>
                      </label>
                      <input
                        className="order-info-input"
                        type="radio"
                        ...
                        value="Самовивіз"
                      />
                      <label htmlFor="by-myself" className="order-info-label">
                        <span className="order-info-title">Самовивіз</span>
                      </label>
                    </form>
                  </div>
                  <div className="type-of-payment">
                    <p className="order-title">
                      <span className="order-title-num">3</span>Оплата
                    </p>
                ...
                <div className="order-submit-reverse">
                  ...
                  <p className="personal-info">
                    *Нажавши кнопку “Оформити замовлення” Ви погоджуєтесь на
