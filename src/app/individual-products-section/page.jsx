          ...
          <div className="container catalog-container">
            ...
            <div>
              <h2 className="title serial-products-title">
                ...
                {t("Individual_products_section_title")}
              </h2>
                    ...
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          ...
                          href="individual-products-section/chairs"
                        >
                          <Image
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_chairs")}
                      </p>
                    </div>
                  </li>
                  <li className="serial-caegories-item">
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          className="serial-caegories-link"
                          href="individual-products-section/sofas"
                        >
                          <Image
                            className="serial-caegories-img"
                            width={167}
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_sofas")}
                      </p>
                    </div>
                  </li>
                  <li className="serial-caegories-item">
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          className="serial-caegories-link"
                          href="individual-products-section/armchairs"
                        >
                          <Image
                            className="serial-caegories-img"
                            width={167}
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_armchairs")}
                      </p>
                    </div>
                  </li>
                  <li className="serial-caegories-item">
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          className="serial-caegories-link"
                          href="individual-products-section/bar-chairs"
                        >
                          <Image
                            className="serial-caegories-img"
                            width={167}
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_bar_stools")}
                      </p>
                    </div>
                  </li>
                  <li className="serial-caegories-item">
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          className="serial-caegories-link"
                          href="individual-products-section/ottomans"
                        >
                          <Image
                            className="serial-caegories-img"
                            width={167}
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_poufs_ottomans")}
                      </p>
                    </div>
                  </li>
                  <li className="serial-caegories-item">
                    <div>
                      <div className="serial-caegories-img-wrapper">
                        <Link
                          className="serial-caegories-link"
                          href="individual-products-section/decor"
                        >
                          <Image
                            className="serial-caegories-img"
                            width={167}
                      ...
                      <p className="serial-caegories-text">
                        {t("Individual_products_section_title_decor")}
                      </p>
                    </div>
                  </li>
                </ul>
