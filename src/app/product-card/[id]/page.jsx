                ...
                <div className="product-card-img">
                  <div className="product-card-gallery">
                    <Image
                      ...
                      width="520"
                      height="520"
                      src="/images/img/product-card/prduct-card1.jpg"
                      alt={data.name}
                    />
                    <div className="product-card-gallery-secondary">
                      <Image
                        ...
                        width="137"
                        height="137"
                        src="/images/img/product-card/prduct-card2.jpg"
                        alt={data.name}
                      />
                      <Image
                        className="product-card-gallery-secondary-img"
                        width="137"
                        height="137"
                        src="/images/img/product-card/prduct-card3.jpg"
                        alt={data.name}
                      />
                      <Image
                        className="product-card-gallery-secondary-img"
                        width="137"
                        height="137"
                        src="/images/img/product-card/prduct-card4.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  <table className="product-card-info-table">
                    <tbody>
                      ...
                      <tr className="product-card-info-table-tr">
                        ...
                        <td className="product-card-info-table-th2">610 mm</td>
                      </tr>
                      <tr className="product-card-info-table-tr">
                        <td className="product-card-info-table-th1">Глибина</td>
                        <td className="product-card-info-table-th2">620 mm</td>
                      </tr>
                      <tr className="product-card-info-table-tr">
                        <td className="product-card-info-table-th1">Висота</td>
                        <td className="product-card-info-table-th2">820 mm</td>
                      </tr>
                      <tr className="product-card-info-table-tr">
                        <td className="product-card-info-table-th1">
                          Висота сидіння
                        </td>
                        <td className="product-card-info-table-th2">460 mm</td>
                      </tr>
                      <tr className="product-card-info-table-tr">
                        <td className="product-card-info-table-th1">Вага</td>
                        <td className="product-card-info-table-th2">9.35 kg</td>
                      </tr>
                      <tr className="product-card-info-table-tr">
                        <td className="product-card-info-table-th1">Об’єм</td>
                        <td className="product-card-info-table-th2">0.31 mm</td>
                      </tr>
                    </tbody>
                  </table>
                  <div className="product-materials">
                    ...
                    <ul className="product-card-info-materials-list">
                      <li className="product-card-info-materials-item">
                        Ніжки - дерево ясен, тонований в колір на вибір
                      </li>
                      <li className="product-card-info-materials-item">
                        Оббивка - тканина або шкірзамінник, натуральна шкіра
                        розраховується окремо у вартість
                      </li>
                      <li className="product-card-info-materials-item">
                        Каркас - фанера, поролон меблевої категорії EL
                      </li>
                    </ul>
            ...
            <div className="product-card-block">
              <div className="product-card-img">
                ...
                <div className="product-card-gallery-info">
                  ...
                  <div className="product-card-gallery-price-block">
                    <div className="product-card-price-none">
                      <h2 className="product-card-info-title">Still chair</h2>
                      <p className="product-card-info-number">
                        Код продукту: A00001
                      </p>
                    </div>
              ...
              <div className="product-card-info">
                <div className="product-card-info-none">
                  <h2 className="product-card-info-title">{data.title}</h2>
                  <p className="product-card-info-number">{data.body}</p>
                </div>
