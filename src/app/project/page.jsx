          ...
          <div className="container container-project">
            ...
            <div>
              <div className="project-info">
                ...
                <div className="project-info-about">
                  <h2 className="project-title">virgin Izakaya</h2>
                  <p className="project-place">Dubai / 2022</p>
                </div>
              ...
              <p className="project-text-about">
                Virgin Izakaya - сучасний японський ресторан на острові
                Блюуотерс, що спеціалізується на традиційній та сучасній
                японській кухні. Автентичні елементи набувають свіжого вигляду у
                поєднанні з творчими прийомами у меню, а й у всій концепції.
                Традиційний гриль-робата знаходиться у центрі ресторану, де
                кухарі створюють страви.
              </p>
                  ...
                  <li className="project-gallery-item">
                    <picture>
                      <source
                        ...
                        height="415"
                        srcSet="
                          /images/img/project-izakaya/project-desctop/inside1.jpg
                        "
                      />
                      <source
                        ...
                        height="228"
                        srcSet="
                          /images/img/project-izakaya/project-tablet/inside1.jpg
                        "
                      />
                      <Image
                        width="167"
                        ...
                        src="/images/img/project-izakaya/project-tablet/inside1.jpg"
                        alt=""
                      />
                    </picture>
                  </li>
                  <li className="project-gallery-item">
                    <picture>
                      <source
                        ...
                        height="415"
                        srcSet="
                          /images/img/project-izakaya/project-desctop/inside2.jpg
                        "
                      />
                      <source
                        media="(min-width: 768px)"
                        ...
                        height="228"
                        srcSet="
                          /images/img/project-izakaya/project-tablet/inside2.jpg
                        "
                      />
                      <Image
                        width="167"
                        height="170"
                        className="project-img"
                        src="/images/img/project-izakaya/project-tablet/inside2.jpg"
                        alt=""
                      />
                    </picture>
                  </li>
                  <li className="project-gallery-item">
                    <picture>
                      <source
                        ...
                        height="415"
                        srcSet="
                          /images/img/project-izakaya/project-desctop/inside3.jpg
                        "
                      />
                      <source
                        media="(min-width: 768px)"
                        ...
                        height="228"
                        srcSet="
                          /images/img/project-izakaya/project-tablet/inside3.jpg
                        "
                      />
                      <Image
                        width="167"
                        height="170"
                        className="project-img"
                        src="/images/img/project-izakaya/project-tablet/inside3.jpg"
                        alt=""
                      />
                    </picture>
                  </li>
            ...
            <div>
              ...
              <ul className="project-used list">
                <li className="project-used-item">
                  <a className="project-used-link" href="">
                    <Image
                      className="project-used-furniture"
                      width="167"
                      height="167"
                      src="/images/img/project-izakaya/project-desctop/furniture1.jpg"
                      alt=""
                    />
                    <div className="project-used-info">
                      <h3 className="project-used-title">DRAGONFLY BAR</h3>
                      <p className="project-used-text">Код продукту: 0005</p>
                    </div>
                  </a>
                </li>
                <li className="project-used-item">
                  <a className="project-used-link" href="">
                    <Image
                      ...
                      width="167"
                      height="167"
                      src="/images/img/project-izakaya/project-desctop/furniture2.jpg"
                      alt=""
                    />
                    <div className="project-used-info">
                      <h3 className="project-used-title">dragonfly chair</h3>
                      <p className="project-used-text">Код продукту: А0018</p>
                    </div>
                  </a>
                </li>
                <li className="project-used-item">
                  <a className="project-used-link" href="">
                    <Image
                      ...
                      width="167"
                      height="167"
                      src="/images/img/project-izakaya/project-desctop/furniture3.jpg"
                      alt=""
                    />
                    <div className="project-used-info">
                      <h3 className="project-used-title">fugu sofa</h3>
                      <p className="project-used-text">Код продукту: S18</p>
                    </div>
                  </a>
                </li>
                <li className="project-used-item">
                  <a className="project-used-link" href="">
                    <Image
                      ...
                      width="167"
                      height="167"
                      src="/images/img/project-izakaya/project-desctop/furniture4.jpg"
                      alt=""
                    />
                    <div className="project-used-info">
                      <h3 className="project-used-title">clasp chair</h3>
                      <p className="project-used-text">Код продукту: А0002</p>
                    </div>
                  </a>
                </li>
              </ul>
